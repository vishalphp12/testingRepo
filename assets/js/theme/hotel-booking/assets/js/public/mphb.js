  ...
  $(function () {
    ...
    MPHB.calendarHelper = {
      ...
      getCalendarDateAttributesFromAvailability: function getCalendarDateAttributesFromAvailability(calendarMode, date, isCurrentMonth, roomTypeCalendarData) {
        ...
        if (2 === calendarMode) {
          // check-in calendar
		  console.log(isCurrentMonth +"--test--"+ calendarDateAttributes.isPastDate +"--test--"+ calendarDateAttributes.isUnavailable +"--test--"+ calendarDateAttributes.isUnavailableCheckIn)
